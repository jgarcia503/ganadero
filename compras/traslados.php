...
?>
            <tr>
                ...
                <td>
                    ...
                    <?php echo check_permiso_for_update($_SESSION[permisos][$_SERVER[REQUEST_URI]], 'Utraslado.php', "id=$fila[id]");?>
                    <!--<a href="Utraslado.php?<?php  echo   $fila[id]?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>-->                    
