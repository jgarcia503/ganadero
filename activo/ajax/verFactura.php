...
$id=$_GET[id];
$sql="select *,b.nombre bodega from compras_activo_lns a inner join bodega b on b.codigo=a.bodega::integer  where enc_id='$id'";
$sql2="select * from compras_activo_enc where id='$id'";
#para ver los gastos asociados a esta compra
$sql3="select concepto,valor from compras_activo_otros_gastos where id_enc=$id";
$res=$conex->query($sql);
