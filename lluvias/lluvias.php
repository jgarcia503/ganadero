...
<a href="Clluvia.php" class="button primary">crear lluvia</a>


<?php
$res=$conex->query("select * from lluvias");
?>
...
while($fila=$res->fetch()){
    ...
    ?>
            <tr>
                ...
                <td><?php  echo $fila[mm]?></td>                
                <td>
                    <a href="#" class="ver" data-id="<?php  echo base64_encode( $fila[id]) ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                    <a href="Ulluvia.php?<?php  echo  base64_encode( $fila[id])?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>                    
                    <a href="Dlluvia.php?<?php  echo  base64_encode('mortalidad='. $fila[id])?>" id="eliminar"><i class="fa fa-trash" aria-hidden="true"></i></a>
                </td>
            </tr>
