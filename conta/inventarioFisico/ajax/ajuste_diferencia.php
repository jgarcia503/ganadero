...
$sql_insert="insert into  inventario_fisico_lns (id,bodega_id,producto_id,cantidad_teorica,cantidad_real,costo,enc_id,comentario_ajuste) "
                              . "values(default,$bod_id,'$ref','0','$cant_conv','$res[precio_promedio]',$enc_id,'$coment_ajuste')";
$sql_update="update inventario_fisico_lns set cantidad_real=$cant_conv,comentario_ajuste='$coment_ajuste'  where producto_id='$ref'  and enc_id=$enc_id";
...
##if existe true 
    ##modificar con el ajuste
##sino
##inserto con el ajuste